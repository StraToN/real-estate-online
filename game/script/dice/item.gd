...
func get_value():
  ...
  l_global_rotation.x = ((int(round(rad2deg(l_global_rotation.x) / PERPANDICULAR_ANGLE)) * PERPANDICULAR_ANGLE) + REVERSE_DICE_ANGLE) % REVERSE_DICE_ANGLE
  l_global_rotation.y = ((int(round(rad2deg(l_global_rotation.y) / PERPANDICULAR_ANGLE)) * PERPANDICULAR_ANGLE) + REVERSE_DICE_ANGLE) % REVERSE_DICE_ANGLE
  l_global_rotation.z = ((int(round(rad2deg(l_global_rotation.z) / PERPANDICULAR_ANGLE)) * PERPANDICULAR_ANGLE) + REVERSE_DICE_ANGLE) % REVERSE_DICE_ANGLE
